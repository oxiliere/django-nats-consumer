...
from nats_consumer.consumer import get_nats_client, NatsConsumer
...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument(
            '--log-level', type=str, choices=['ERROR', 'WARNING', 'INFO', 'DEBUG'], default='INFO',
            help='Log level: ERROR, WARNING, INFO, DEBUG'
        )
        parser.add_argument(
            '--create-stream', action='store_true', help='Setup the stream before running the consumer'
        )
